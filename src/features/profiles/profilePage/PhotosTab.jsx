...
const PhotosTab = ({profile, isCurrentUser}) => {
    ...
    const [deleting, setDeleting] = useState({isiDeleting: false, target: null});
    ...
    async function handleDeletePhoto(photo, target) {
        setDeleting({isiDeleting: true, target});
        try {
            ...
            setDeleting({isiDeleting: false, target: null});
        }
    }
                                ...
                                {photos.map(photo => (
                                    <Card key={photo.id}>
                                        ...
                                        <Button.Group fluid widths={2}>
                                            ...
                                            <Button 
                                                name={photo.id}
                                                loading={deleting.isiDeleting && deleting.target === photo.id}
